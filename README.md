...
[comment]:<> ### Citation
[comment]:<> If you use FDRnet in your work, please cite the following manuscript:
[comment]:<> L. Yang, R. Chen, S. Goodison, Y. Sun. FDRnet:  A novel method to identify significantly mutated subnetworks in cancer.
